...
<head>
    ...
    <meta content="sB1fwPBk-q0jazw28JRys5RGFDnNKR7zcz8g" name="csrf-token">
</head>
<body>
<!-- navbar -->
<div class='navbar'>
...
<div id='main'>
    ...
    <div id='content'>
        <div class='panel'>
            <div class='header'>
                <ol class='breadcrumb'>
                    <li><a href='/topic_css'>主页</a><span class='divider'>/</span></li>
            ...
            <div class='inner post'>
                ...
                <form id='create_topic_form' action='/topic_css/create' method='post'>
                ...
                ></textarea>
                        ...
                        <input type='hidden' name='_csrf' value='sB1fwPBk-q0jazw28JRys5RGFDnNKR7zcz8g'>
                    </fieldset>
                </form>
            </div>
