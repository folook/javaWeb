...
<head>
    ...
    <title>Zihuatanejo 板块${boardId}</title>
    ...
    <div class='navbar-inner'>
        <div class='container'>
            <a class='brand' >
                ...
                <p> 欢迎 ${currentUser.username} 来到板块${boardId} </p>
    ...
    <div id='sidebar'>
            ...
            <div class='inner'>
                <div class='user_card'>
                    <div>
                        ...
                        <span class='user_name'><a class='dark' href="/user/${currentUser.username}">${currentUser.username}</a></span>
        ...
        <div class='panel'>
            ...
            <div class='inner'>
                ...
                <p>欢迎您来到 Zihuatanejo，Zihuatanejo 中文译名是芝华塔尼欧，是电影《肖申克的救赎中》主人公安迪越狱后前往的地方</p>
            </div>
        </div>
                ...
                <div id="topic_list">
                    <#list boardTopic as t>
                        ...
                        <div class='cell'>
                            ...
                            <a class="user_avatar pull-left" href="/user/profile?id=${t.userId}">
...
<#--                                <img class="user_small_avatar" src="https://avatars1.githubusercontent.com/u/65359071?v=4&amp;s=120">-->
