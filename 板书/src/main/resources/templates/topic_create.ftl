...
<head>
    ...
    <!-- scripts -->
    <script src="/topic_js/topic_creat.js"></script>
    ...
    <meta content="GoOtXwYE-NvX2jgGgbUWoMkQso_1a0Ow20KI" name="csrf-token">
</head>
<body>
<!-- navbar -->
<div class='navbar'>
...
<div id='main'>
        ...
        <div class='panel'>
            ...
            <div class='inner post'>
                ...
                <form id='create_topic_form' action='/topic/add' method='post'>
                    ...
                    <fieldset>
                        ...
                        <select name="boardId" id="tab-value">
                            ...
                            <option value=1 >板块 1</option>


                            <option value=2 >板块 2</option>


                            <option value=3 >板块 3</option>
                ...
                ></textarea>
                        ...
                        <input type='hidden' name='_csrf' value='GoOtXwYE-NvX2jgGgbUWoMkQso_1a0Ow20KI'>
                    </fieldset>
                </form>
            </div>
    ...
    <!-- markdown editor -->
    <script src="/topic_js/topic_creat2.js"></script>
